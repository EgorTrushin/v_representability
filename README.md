...
- E. Trushin, J. Erhard and A. Görling. Violations of the v-representability condition underlying Kohn-Sham density-functional theory - Phys. Rev. A 110 L020802 (2024) https://doi.org/10.1103/PhysRevA.110.L020802
    - Click to see corresponding [Jupyter Notebook](https://github.com/EgorTrushin/v_representability/blob/main/vrepr-violation.ipynb)
    - Zenodo repository: [http://doi.org/10.5281/zenodo.8226492](http://doi.org/10.5281/zenodo.12772192)

---

Script [gen_inputs.py](https://github.com/EgorTrushin/v_representability/blob/main/gen_inputs.py) creates all input files for Molpro, besides inputs for KS inversion using FCI target densities and other calculations which supplement FCI-based results. The script uses config files from the **configs** directory.
...
Notebook [vrepr-violation.ipynb](https://github.com/EgorTrushin/v_representability/blob/main/vrepr-violation.ipynb) generates tables and figures, i.e., provides analytics. [vrepr-violation.html](https://github.com/EgorTrushin/v_representability/blob/main/vrepr-violation.html) contains only output of [vrepr-violation.ipynb](https://github.com/EgorTrushin/v_representability/blob/main/vrepr-violation.ipynb), i.e., cells with codes are absent.

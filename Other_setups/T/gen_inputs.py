...
acfd;uscexx,dfit=0,maxit=100,energy=1d-10,vhoep=1,thr_fai_oep=5d-2{method}
"""
...
acfd;ksinv,maxit=100,refden=2140.2,e_ref=e_ref,vhoep=1,thr_fai_oep=5d-2,density_test=1,noa={noa},nob={nob}{method}
"""
